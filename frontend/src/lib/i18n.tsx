...
const STRINGS = {
  ...
  'hazard.searchingPlaces': ['Searching places…', 'ठाउँ खोजिँदैछ…'],
  'hazard.loadingAddress': ['Loading Point B address…', 'बिन्दु B को ठेगाना लोड हुँदैछ…'],
  ...
  'notifications.all': ['All', 'सबै'],
  'notifications.unread': ['Unread', 'नपढिएका'],
  'notifications.read': ['Read', 'पढिएका'],
  'notifications.filter': ['Filter notifications', 'सूचना फिल्टर'],
  'notifications.noneAll': ['No notifications yet', 'अहिलेसम्म कुनै सूचना छैन'],
  'notifications.noneUnread': ['You have read every notification', 'तपाईंले सबै सूचना पढिसक्नुभएको छ'],
  'notifications.noneRead': ['No read notifications yet', 'अहिलेसम्म पढिएका सूचना छैनन्'],
  ...
  'transparency.title': ['Public dashboard', 'सार्वजनिक ड्यासबोर्ड'],
  'transparency.hint': [
  ...
  'dashboard.open': ['Open civic reports', 'खुला नागरिक उजुरी'],
  'dashboard.pendingReview': ['Reports awaiting duplicate review', 'नक्कल समीक्षा पर्खिरहेका उजुरी'],
  'dashboard.openSos': ['Active SOS emergencies', 'सक्रिय SOS आपतकाल'],
  'dashboard.resolved': ['Resolved civic reports', 'समाधान भएका नागरिक उजुरी'],
  ...
  'common.success': ['Changes saved.', 'परिवर्तन सुरक्षित भयो।'],
  ...
  'pwa.install': ['Install app', 'एप इन्स्टल गर्नुहोस्'],
  'pwa.installed': ['App installed', 'एप इन्स्टल भयो'],
  'pwa.alreadyInstalled': ['Sahayatri is already installed.', 'सहयात्री पहिले नै इन्स्टल भएको छ।'],
  'pwa.browserInstall': [
    'Open your browser menu and choose “Install app” or “Add to Home Screen”.',
    'ब्राउजर मेनु खोलेर “एप इन्स्टल गर्नुहोस्” वा “होम स्क्रिनमा थप्नुहोस्” छान्नुहोस्।',
  ],
  'pwa.installSuccess': ['Sahayatri was installed.', 'सहयात्री इन्स्टल भयो।'],
